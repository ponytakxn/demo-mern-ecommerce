...
const CartPageComponent = ({ addToCart, reduxDispatch, cartItems, cartSubtotal, removeFromCart }) => {
                    ...
                    <ListGroup>
                        ...
                        <ListGroup.Item>
                            <LinkContainer to="/user/cart-details">
                                <Button disabled={cartItems.length===0} type="button" variant="primary">Proceed to checkout</Button>
                            </LinkContainer>
                        </ListGroup.Item>
                    </ListGroup>
                </Col>
