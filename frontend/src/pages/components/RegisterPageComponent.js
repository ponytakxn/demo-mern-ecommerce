            ...
            <Row className="mt-5">
                <Col md={6}>
                    ...
                    <Form noValidate validated={validated} onSubmit={handleSubmit}>
                        ...
                        <Alert className="mt-2" show={registerUserResponseState && registerUserResponseState.error==='user exists'} variant="danger">
                            User with that email already exists!
                        </Alert>
                        <Alert className="mt-1" show={registerUserResponseState && registerUserResponseState.success==='User created'} variant="info">
